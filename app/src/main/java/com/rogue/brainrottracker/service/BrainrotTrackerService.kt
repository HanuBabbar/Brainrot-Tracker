...
import com.rogue.brainrottracker.service.engines.PlatformRegistry
import com.rogue.brainrottracker.service.engines.TrackedPlatform
...
class BrainrotTrackerService : AccessibilityService() {
    ...
    companion object {
        const val ACTION_DISABLE_SERVICE = "com.rogue.brainrottracker.ACTION_DISABLE_SERVICE"
        const val ACTION_NOTIFICATION_DISMISSED = "com.rogue.brainrottracker.ACTION_NOTIFICATION_DISMISSED"
